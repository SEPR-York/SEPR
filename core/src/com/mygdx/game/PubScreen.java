...
public class PubScreen implements Screen
{
    ...
    public void show()
    {
        ...
        buttons[5].addListener(new ChangeListener() {
            public void changed(ChangeEvent event, Actor actor) {
                // When this button is clicked play the rouletteNumber game with the number that was randomly selected upon entry to the pub
        ...
        buttons[8].addListener(new ChangeListener() {
            public void changed(ChangeEvent event, Actor actor) {
                // When this button is clicked play the lucky dip
        ...
        buttons[11].addListener(new ChangeListener() { 																//to the button so when it is pressed it sends you back to the main menu
            public void changed(ChangeEvent event, Actor actor) {
                // When this button is pressed leave the pub and return to the game screen
    ...
    public void render(float delta) {
        ...
        // Set line one to update to the players current amout of money and their name
        String line1 = "Player " + player.getName() + " \t Money " + player.getMoney();
        buttons[1].setText(line1);

        // If they don't have enough money to gameble
        if (player.getMoney() < Gamble.GetPriceToPlayRoulette() || player.getMoney() < Gamble.GetPriceToPlayLuckyDip())
        {
            ...
            // Display a dialog to tell the player they are being kicked out of the pub
            ...
            // Set game game screen back to the pub
            game.setScreen(gameScreen);
        }
